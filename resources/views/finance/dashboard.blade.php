...
@section('welcome')
	<h1 class="text-xl font-semibold mb-1">Welkom terug, Mohammed 👋</h1>
	...
	<div class="flex flex-wrap gap-3">
		...
		<button class="bg-white/10 border border-white/20 text-white text-sm px-4 py-2 rounded">+ Creditnota</button>
		<button class="bg-white/10 border border-white/20 text-white text-sm px-4 py-2 rounded">📊 Rapportages</button>
	</div>
@endsection
...
@section('stats')
	...
	<div class="flex-1 min-w-0 bg-white border border-gray-200 rounded-lg p-4">
		...
		<div class="flex items-center gap-2 text-sm text-red-600 mt-2">↓ 12% <span class="text-gray-400">vs vorige maand</span></div>
	</div>

	<div class="flex-1 min-w-0 bg-white border border-gray-200 rounded-lg p-4">
		<div class="flex justify-between items-start">
			<h3 class="text-sm text-gray-500">Gem. Betaaltermijn</h3>
